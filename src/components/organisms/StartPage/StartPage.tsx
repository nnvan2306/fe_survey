...
import { SurveySecurityMode, SurveySpecificTopic, SurveyTopic } from "../../../data/surveyData";
...
function SurveyStatus({ surveyStatusChecked: surveyStatusChecked, setSurveyStatusChecked: setSurveyStatusChecked, setFormData: setFormData }: any) {
    return <>
        <div className="config-section">
...
function CustomizePassword({ selectedSecurityMode: selectedSecurityMode, setSelectedSecurityMode: setSelectedSecurityMode, handleCustomizePassword: handleCustomizePassword, setFormData: setFormData }: any) {
    return <>
        <div className="config-section">
            <div className="flex items-center mb-3">
                <h3 className="config-title">
...
function SecurityMode({ selectedSecurityMode: selectedSecurityMode, setSelectedSecurityMode: setSelectedSecurityMode, setFormData: setFormData }: any) {
    return <>
        <div>
            ...
            <FormControl fullWidth sx={{
                ...
                <Select
                    ...
                    onChange={(e) => {
                        ...
                        setFormData((prev: any) => ({ ...prev, securityModeId: newSecurityModeId }));
                    }}
                >
